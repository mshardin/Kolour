...
* miscellaneous
*/
define("BASE_URL", "www.nool.com");

/**
 * Configuration for: Database Connection
 */
define("DB_HOST", "mysql.nool.me");
define("DB_NAME", "nool");
define("DB_USER", "nool_admin");
define("DB_PASS", "i-am-from-trinidad");
...
define("COOKIE_DOMAIN", "www.nool.me");
 ...
 */
define("EMAIL_USE_SMTP", true);
define("EMAIL_SMTP_HOST", "ssl://mail.nool.me");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "admin@nool.me");
define("EMAIL_SMTP_PASSWORD", "i-am-from-trinidad");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://nool.me/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "admin@nool.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Nool Admin");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for Nool");
define("EMAIL_PASSWORDRESET_CONTENT", "Please click on this link to reset your Nool password:");

/**
 * Configuration for: verification email data
 * Set the absolute URL to register.php, necessary for email verification links
 */
define("EMAIL_VERIFICATION_URL", "http://nool.me/register.php");
define("EMAIL_VERIFICATION_FROM", "admin@nool.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Nool Admin");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Nool");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your Nool account:");
