...
<div id="wrapper">
	<div id="sign-bar">
		...
		<img class="login-container" src="https://d20gj6m76a89ac.cloudfront.net/images/kolour-logo2.svg">
		...
		<form class="login-container" autocomplete="off" method="post" action="index.php" name="loginform">
			...
			<button class="btn small-text" style="background:#383034; position:relative;" type="submit" name="login"><span id="btn-text">Start Kolouring</span><img id="arrow" src="https://d20gj6m76a89ac.cloudfront.net/images/go-btn.svg"></button>
		</form>
	<span id="login-footer" class="smaller-text"><a href="register.php">Register</a>|<a href="password_reset.php">Forgot Password?</a></span>
        ...
        <img class="login-container" id="banner" src="https://d20gj6m76a89ac.cloudfront.net/images/banner-icons.svg">
		<!--<img id="btm-border" src="../views/Images/point-border.svg">-->
        <img id="btm-border" src="https://d20gj6m76a89ac.cloudfront.net/images/point-border.svg">
	</div>
</div>
