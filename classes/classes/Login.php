...
class Login
{
    ...
    /**
     * __construct automatically starts whenever an object of this class is created,
    ...
    /**
     * TODO: This returns two different types. We should rework this.
     */
    private function getUserData($user_name)
    {
        ...
        if ($this->databaseConnection()) {
            ...
            $query_user = $this->db_connection->prepare('SELECT * FROM users WHERE user_name = :user_name LIMIT 1');
    ...
    private function loginWithPostData($user_name, $user_password, $user_rememberme)
    {
        ...
        // if POST data (from login form) contains non-empty user_name and non-empty user_password
            ...
            // if user has typed a valid email address, we try to identify him with his user_email
                ...
                // database query, getting all the info of the selected user
                $query_user = $this->db_connection->prepare('SELECT * FROM users WHERE user_email = :user_email LIMIT 1');
    ...
    // public function createMongoDBTemplate() {
